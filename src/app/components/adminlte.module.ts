...
import {EtSwitchModule} from './switch/switch';
import {FormTooltipModule} from './formTooltip/formTooltip';
import {LteMessageService} from './message/message.service';
  ...
  static forRoot(): ModuleWithProviders {
    ...
    return {
      ...
      providers: [
        ...
        {provide: ExDynamicService, useClass: ExDynamicService},
        {provide: LteMessageService, useClass: LteMessageService}
      ]
    };
  }
}
