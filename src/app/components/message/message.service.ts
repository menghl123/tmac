...
@Injectable()
export class LteMessageService {

  components: any[] = [];

  constructor(@Optional() private root: LteMessageContainer,
  ...
  createComponent(): void {
    const com: ComponentRef<any> = this.dynamic.generator(LteMessageContainer);
